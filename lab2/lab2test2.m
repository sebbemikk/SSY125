...
maxNum = 20*1e5; % OR stop if maxNum bits have been simulated
...
% trellis = poly2trellis([4 4], [2 11 10 ; 4 11 10],[11 10]); %not sure
...
semilogy(EbN0 + 10*log10(1),BER,'xr')
...
semilogy(EbN0,berub); %ylabel('Upper Bound on BER');
axis([-4 12 10^(-6) 1])

legend('Hard Decoded','Soft Decoded','Uncoded Transmission','Theoetical uncoded','Upper bound (Soft)')
